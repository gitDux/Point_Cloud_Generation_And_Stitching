...
cd %inputFolder%
echo bug here
echo for %%I in (*.%inputMeshFormat%) do (%meshlabserverPath% -i %%I -o .\%outputFolder%\%%~nI.%outputMeshFormat% %outputMeshOptions%)
for %%I in (*.%inputMeshFormat%) do (%meshlabserverPath% -i %%I -o ..\%outputFolder%\%%~nI.%outputMeshFormat% %outputMeshOptions%)
rem To get help on the "for" syntax use: for /?
